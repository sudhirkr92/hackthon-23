pipeline {
    ...
    stages {
        ...
        stage('Deploy to AWS') {
             steps {
                sh 'scp ./script/deploy.sh ec2-user@ec2-13-233-12-165.ap-south-1.compute.amazonaws.com:~/'
                sh 'ssh ec2-user@ec2-13-233-12-165.ap-south-1.compute.amazonaws.com chmod +x deploy.sh'
                sh 'ssh ec2-user@ec2-13-233-12-165.ap-south-1.compute.amazonaws.com ./deploy.sh'
                }
            }
       }
}
